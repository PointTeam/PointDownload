...
void Aria2Process::startDownload()
{
    ...
    SDownloading tmpStruct = tmpOpera.getDownloadingNode(gInfo.downloadURL);
    if (tmpStruct.readySize == "0" || tmpStruct.readySize == "")
        arguments << QString("--allow-overwrite=true");
